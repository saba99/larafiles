                    ...
                    <div class="forum_detail_area ">
                        <div class="cardify forum--issue">
                            ...
                            <div class="suppot_query_tag">
                                <a href="#" class="user">
                                    <img class="poster_avatar" src="/assets/images/new/support_avat1.png" alt="Support Avatar"> علی تقی پور</a>
                        ...
                        <div class="forum--replays cardify">
                            ...
                            <div class="forum_single_reply">
                                ...
                                <div class="reply_avatar">
                                    <img src="/assets/images/new/notification_head2.png" alt="reply avatar">
                                </div>
                            ...
                            <div class="comment-form-area">
                                ...
                                <div class="media comment-form support__comment">
                                    ...
                                    <div class="media-body">
                                        <form action="{{route('ticket.create')}}"  method="post" class="comment-reply-form" enctype="multipart/form-data">
                                            @csrf
                                       
                                            <div class="form-group">
                                        <label for="title">عنوان مطلب
                                            <sup>*</sup>
                                        </>
                                        <input type="text" name="title" id="title" class="text_field">

                                    </div>
                                    <div class="form-group">
                                        <label for="department">بخش
                                            <sup>*</sup>
                                        </label>
                                        <div class="select-wrap select-wrap2">
                                            <select  name="department" id="department" class="text_field">
                                    ...
                                    <div class="form-group">
                                        <label for="department">اولویت
                                            <sup>*</sup>
                                        </label>
                                        <div class="select-wrap select-wrap2">
                                            <select  name="priority" id="priority" class="text_field">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="text" id="text" class="text_field" ></textarea>
                                    </div>
                                    <div class="form-group">
                                <lable for="file">پیوست </lable>
                                  <input type="file"  name="file"  id="file" class="text_field" >
                               </div>
